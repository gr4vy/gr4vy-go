...
func newPaymentServices(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PaymentServices {
...
func (s *PaymentServices) Get(ctx context.Context, paymentServiceID string, merchantAccountID *string, opts ...operations.Option) (*components.PaymentService, error) {
...
func (s *PaymentServices) Delete(ctx context.Context, paymentServiceID string, merchantAccountID *string, opts ...operations.Option) error {
