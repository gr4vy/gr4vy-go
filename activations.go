...
func newActivations(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Activations {
	return &Activations{
		rootSDK:          rootSDK,
...
func (s *Activations) Create(ctx context.Context, giftCardActivationCreate components.GiftCardActivationCreate, idempotencyKey *string, merchantAccountID *string, opts ...operations.Option) (*components.GiftCard, error) {
	request := operations.ActivateGiftCardRequest{
		IdempotencyKey:           idempotencyKey,
		MerchantAccountID:        merchantAccountID,
		GiftCardActivationCreate: giftCardActivationCreate,
	}

	globals := operations.ActivateGiftCardGlobals{
	...
	opURL, err := url.JoinPath(baseURL, "/gift-cards/activations")
	if err != nil {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "GiftCardActivationCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
