...
func newIssuances(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Issuances {
	return &Issuances{
		rootSDK:          rootSDK,
...
func (s *Issuances) Create(ctx context.Context, giftCardIssuanceCreate components.GiftCardIssuanceCreate, idempotencyKey *string, merchantAccountID *string, opts ...operations.Option) (*components.GiftCardIssuance, error) {
	request := operations.IssueGiftCardRequest{
		IdempotencyKey:         idempotencyKey,
		MerchantAccountID:      merchantAccountID,
		GiftCardIssuanceCreate: giftCardIssuanceCreate,
	}

	globals := operations.IssueGiftCardGlobals{
	...
	opURL, err := url.JoinPath(baseURL, "/gift-cards/issuances")
	if err != nil {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "GiftCardIssuanceCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GiftCardIssuance
