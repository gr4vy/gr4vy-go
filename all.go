...
func newAll(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *All {
	return &All{
		rootSDK:          rootSDK,
...
func (s *All) Create(ctx context.Context, transactionID string, merchantAccountID *string, transactionRefundAllCreate *components.TransactionRefundAllCreate, opts ...operations.Option) (*components.CollectionRefund, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, true, true, "TransactionRefundAllCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
