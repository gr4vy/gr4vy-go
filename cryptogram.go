...
func newCryptogram(sdkConfig sdkConfiguration) *Cryptogram {
	return &Cryptogram{
...
func (s *Cryptogram) Create(ctx context.Context, request operations.CreatePaymentMethodNetworkTokenCryptogramRequest, opts ...operations.Option) (*operations.CreatePaymentMethodNetworkTokenCryptogramResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CryptogramCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 403:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.Response403CreatePaymentMethodNetworkTokenCryptogram
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
