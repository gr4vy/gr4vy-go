...
func (u *Body) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &checkoutSessionPaymentMethodCreate, "", true, false); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &cardPaymentMethodCreate, "", true, false); err == nil {
