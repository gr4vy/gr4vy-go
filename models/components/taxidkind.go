...
const (
	...
	TaxIDKindCoCc       TaxIDKind = "co.cc"
	TaxIDKindCoCe       TaxIDKind = "co.ce"
	TaxIDKindCoDe       TaxIDKind = "co.de"
	TaxIDKindCoRc       TaxIDKind = "co.rc"
	TaxIDKindCoTi       TaxIDKind = "co.ti"
	TaxIDKindCoPassport TaxIDKind = "co.passport"
...
func (e *TaxIDKind) IsExact() bool {
	if e != nil {
		switch *e {
		case "ae.trn", "au.abn", "ar.dni", "ar.cuil", "ar.cuit", "br.cnpj", "br.cpf", "ca.bn", "ca.gst_hst", "ca.pst_bc", "ca.pst_mb", "ca.pst_sk", "ca.qst", "ch.vat", "cl.tin", "co.itin", "co.nit", "co.cc", "co.ce", "co.de", "co.rc", "co.ti", "co.passport", "es.cif", "eu.vat", "gb.vat", "hk.br", "id.nik", "id.npwp", "in.gst", "in.pan", "jp.cn", "jp.rn", "kr.brn", "li.uid", "mx.curp", "mx.rfc", "my.frp", "my.itn", "my.nric", "my.sst", "no.vat", "nz.gst", "pe.ruc", "ph.tin", "ru.inn", "ru.kpp", "sa.vat", "sg.gst", "sg.uen", "th.id", "th.vat", "tw.vat", "us.ein", "za.vat", "bo.ci", "uy.rut", "uy.ci":
			return true
		}
	}
	return false
