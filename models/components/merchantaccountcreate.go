...
func (m *MerchantAccountCreate) GetLoonMerchantAccountID() *string {
	if m == nil {
		return nil
	}
...
func (m *MerchantAccountCreate) GetDiscoverNetworkTokensRequestorID() *string {
	if m == nil {
		return nil
	}
...
func (m *MerchantAccountCreate) GetDiscoverNetworkTokensAppID() *string {
	if m == nil {
		return nil
	}
