...
const (
	...
	RedirectPaymentMethodCreateMethodBreb              RedirectPaymentMethodCreateMethod = "breb"
	RedirectPaymentMethodCreateMethodAch               RedirectPaymentMethodCreateMethod = "ach"
	RedirectPaymentMethodCreateMethodCapitec           RedirectPaymentMethodCreateMethod = "capitec"
	RedirectPaymentMethodCreateMethodCashapp           RedirectPaymentMethodCreateMethod = "cashapp"
	RedirectPaymentMethodCreateMethodCashappafterpay   RedirectPaymentMethodCreateMethod = "cashappafterpay"
	RedirectPaymentMethodCreateMethodClearpay          RedirectPaymentMethodCreateMethod = "clearpay"
	RedirectPaymentMethodCreateMethodCustomPush        RedirectPaymentMethodCreateMethod = "custom_push"
	RedirectPaymentMethodCreateMethodCustomRedirect    RedirectPaymentMethodCreateMethod = "custom_redirect"
	RedirectPaymentMethodCreateMethodCustomTokenize    RedirectPaymentMethodCreateMethod = "custom_tokenize"
	...
	RedirectPaymentMethodCreateMethodDuitnow           RedirectPaymentMethodCreateMethod = "duitnow"
	RedirectPaymentMethodCreateMethodEbanx             RedirectPaymentMethodCreateMethod = "ebanx"
	RedirectPaymentMethodCreateMethodEckoh             RedirectPaymentMethodCreateMethod = "eckoh"
	...
	RedirectPaymentMethodCreateMethodInterac           RedirectPaymentMethodCreateMethod = "interac"
	...
	RedirectPaymentMethodCreateMethodKonbini           RedirectPaymentMethodCreateMethod = "konbini"
	...
	RedirectPaymentMethodCreateMethodOnlinebankingcz   RedirectPaymentMethodCreateMethod = "onlinebankingcz"
	RedirectPaymentMethodCreateMethodOnelink           RedirectPaymentMethodCreateMethod = "onelink"
	...
	RedirectPaymentMethodCreateMethodPaybybank         RedirectPaymentMethodCreateMethod = "paybybank"
	...
	RedirectPaymentMethodCreateMethodPaysquad          RedirectPaymentMethodCreateMethod = "paysquad"
	RedirectPaymentMethodCreateMethodPaypal            RedirectPaymentMethodCreateMethod = "paypal"
	RedirectPaymentMethodCreateMethodPaypaldirectorder RedirectPaymentMethodCreateMethod = "paypaldirectorder"
	RedirectPaymentMethodCreateMethodPaypalpaylater    RedirectPaymentMethodCreateMethod = "paypalpaylater"
	RedirectPaymentMethodCreateMethodPaypay            RedirectPaymentMethodCreateMethod = "paypay"
	...
	RedirectPaymentMethodCreateMethodSeveneleven       RedirectPaymentMethodCreateMethod = "seveneleven"
	RedirectPaymentMethodCreateMethodSezzle            RedirectPaymentMethodCreateMethod = "sezzle"
	...
	RedirectPaymentMethodCreateMethodSwish             RedirectPaymentMethodCreateMethod = "swish"
	RedirectPaymentMethodCreateMethodStripe            RedirectPaymentMethodCreateMethod = "stripe"
	...
	RedirectPaymentMethodCreateMethodWero              RedirectPaymentMethodCreateMethod = "wero"
...
func (e *RedirectPaymentMethodCreateMethod) IsExact() bool {
	if e != nil {
		switch *e {
		case "abitab", "affirm", "afterpay", "alipay", "alipayhk", "arcuspaynetwork", "bacs", "bancontact", "bcp", "becs", "bitpay", "blik", "boleto", "boost", "breb", "ach", "capitec", "cashapp", "cashappafterpay", "clearpay", "custom_push", "custom_redirect", "custom_tokenize", "dana", "dcb", "dlocal", "duitnow", "ebanx", "eckoh", "efecty", "eps", "everydaypay", "gcash", "gem", "gemds", "giropay", "givingblock", "gocardless", "gopay", "grabpay", "ideal", "interac", "kakaopay", "kcp", "khipu", "klarna", "konbini", "latitude", "latitudeds", "laybuy", "linepay", "linkaja", "maybankqrpay", "mercadopago", "multibanco", "multipago", "netbanking", "nupay", "nequi", "oney_10x", "oney_12x", "oney_3x", "oney_4x", "oney_6x", "onlinebankingcz", "onelink", "ovo", "oxxo", "p24", "pagoefectivo", "paybybank", "payid", "paymaya", "paysquad", "paypal", "paypaldirectorder", "paypalpaylater", "paypay", "payto", "payvalida", "picpay", "pix", "pse", "rabbitlinepay", "rapipago", "razorpay", "redpagos", "scalapay", "sepa", "servipag", "seveneleven", "sezzle", "shopeepay", "singteldash", "smartpay", "sofort", "spei", "stitch", "swish", "stripe", "stripedd", "stripetoken", "tapi", "tapifintechs", "thaiqr", "touchngo", "truemoney", "trustly", "trustlyeurope", "upi", "venmo", "vipps", "waave", "webpay", "wechat", "wero", "yape", "zippay":
			return true
		}
	}
	return false
