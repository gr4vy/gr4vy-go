...
value := components.NameTransactionUpdatedStatus
...
| `NamePaymentConnectorResponseTransactionAuthorizationIncrementSucceeded` | payment-connector-response-transaction-authorization-increment-succeeded |
...
| `NamePlaidRequestEvent`                                                  | plaid-request-event                                                      |