...
func main() {
    ...
    res, err := s.Transactions.Settlements.Get(ctx, "7099948d-7286-47e4-aad8-b68f7eb44591", "b1e2c3d4-5678-1234-9abc-1234567890ab", nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.Transactions.Settlements.List(ctx, "7099948d-7286-47e4-aad8-b68f7eb44591", nil)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
