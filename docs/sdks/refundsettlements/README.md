...
<!-- UsageSnippet language="go" operationID="get_transaction_refund_settlement" method="get" path="/transactions/{transaction_id}/refund-settlements/{settlement_id}" -->
```go
package main
...
**[*components.RefundSettlement](../../models/components/refundsettlement.md), error**
...
<!-- UsageSnippet language="go" operationID="list_transaction_refund_settlements" method="get" path="/transactions/{transaction_id}/refund-settlements" -->
```go
package main
...
**[*components.RefundSettlements](../../models/components/refundsettlements.md), error**
