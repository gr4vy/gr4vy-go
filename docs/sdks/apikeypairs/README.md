...
<!-- UsageSnippet language="go" operationID="list_api_key_pairs" method="get" path="/api-key-pairs" -->
```go
package main
...
**[*operations.ListAPIKeyPairsResponse](../../models/operations/listapikeypairsresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="create_api_key_pair" method="post" path="/api-key-pairs" -->
```go
package main
...
**[*components.APIKeyPair](../../models/components/apikeypair.md), error**
...
<!-- UsageSnippet language="go" operationID="get_api_key_pair" method="get" path="/api-key-pairs/{api_key_pair_id}" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="update_api_key_pair" method="put" path="/api-key-pairs/{api_key_pair_id}" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="delete_api_key_pair" method="delete" path="/api-key-pairs/{api_key_pair_id}" -->
```go
package main
