...
type BuyersGiftCards struct {
	rootSDK          *Gr4vy
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newBuyersGiftCards(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *BuyersGiftCards {
	return &BuyersGiftCards{
		rootSDK:          rootSDK,
...
func (s *BuyersGiftCards) List(ctx context.Context, request operations.ListBuyerGiftCardsRequest, opts ...operations.Option) (*components.GiftCardSummaries, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/buyers/gift-cards")
	if err != nil {
