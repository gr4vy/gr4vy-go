...
func newCheckoutSessions(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *CheckoutSessions {
...
func (s *CheckoutSessions) Create(ctx context.Context, merchantAccountID *string, checkoutSessionCreate *components.CheckoutSessionCreate, opts ...operations.Option) (*components.CheckoutSession, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "CheckoutSessionCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *CheckoutSessions) Update(ctx context.Context, sessionID string, checkoutSessionCreate components.CheckoutSessionCreate, merchantAccountID *string, opts ...operations.Option) (*components.CheckoutSession, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "CheckoutSessionCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
