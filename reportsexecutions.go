...
func newReportsExecutions(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ReportsExecutions {
...
func (s *ReportsExecutions) Get(ctx context.Context, reportExecutionID string, merchantAccountID *string, opts ...operations.Option) (*components.ReportExecution, error) {
