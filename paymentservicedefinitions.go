...
func newPaymentServiceDefinitions(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PaymentServiceDefinitions {
...
func (s *PaymentServiceDefinitions) List(ctx context.Context, cursor *string, limit *int64, opts ...operations.Option) (*operations.ListPaymentServiceDefinitionsResponse, error) {
	request := operations.ListPaymentServiceDefinitionsRequest{
		Cursor: cursor,
		Limit:  limit,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/payment-service-definitions")
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CollectionPaymentServiceDefinition
...
func (s *PaymentServiceDefinitions) Get(ctx context.Context, paymentServiceDefinitionID string, opts ...operations.Option) (*components.PaymentServiceDefinition, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/payment-service-definitions/{payment_service_definition_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PaymentServiceDefinition
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *PaymentServiceDefinitions) Session(ctx context.Context, paymentServiceDefinitionID string, requestBody map[string]any, opts ...operations.Option) (*components.CreateSession, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/payment-service-definitions/{payment_service_definition_id}/sessions", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
