...
func newRoles(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Roles {
	return &Roles{
		rootSDK:          rootSDK,
...
func (s *Roles) List(ctx context.Context, cursor *string, limit *int64, opts ...operations.Option) (*operations.ListRolesResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CollectionRole
