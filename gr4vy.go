...
// Generated from OpenAPI doc version 1.0.0 and generator version 2.918.3
...
func New(opts ...SDKOption) *Gr4vy {
	sdk := &Gr4vy{
		SDKVersion: "1.12.126",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 1.12.126 2.918.3 1.0.0 github.com/gr4vy/gr4vy-go",
	...
	sdk.APIKeyPairs = newAPIKeyPairs(sdk, sdk.sdkConfiguration, sdk.hooks)
