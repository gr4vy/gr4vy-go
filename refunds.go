...
func newRefunds(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Refunds {
	return &Refunds{
		rootSDK:          rootSDK,
...
// Get refund
// Fetch a refund.
func (s *Refunds) Get(ctx context.Context, refundID string, merchantAccountID *string, opts ...operations.Option) (*components.Refund, error) {
