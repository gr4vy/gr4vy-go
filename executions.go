...
func newExecutions(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Executions {
	return &Executions{
		rootSDK:          rootSDK,
...
func (s *Executions) List(ctx context.Context, reportID string, cursor *string, limit *int64, merchantAccountID *string, opts ...operations.Option) (*operations.ListReportExecutionsResponse, error) {
	request := operations.ListReportExecutionsRequest{
		ReportID:          reportID,
		Cursor:            cursor,
		Limit:             limit,
	...
	globals := operations.ListReportExecutionsGlobals{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/reports/{report_id}/executions", request, globals)
	if err != nil {
	...
	res := &operations.ListReportExecutionsResponse{}
	res.Next = func() (*operations.ListReportExecutionsResponse, error) {
...
func (s *Executions) URL(ctx context.Context, reportID string, reportExecutionID string, merchantAccountID *string, opts ...operations.Option) (*components.ReportExecutionURL, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/reports/{report_id}/executions/{report_execution_id}/url", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ReportExecutionURL
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
func (s *Executions) All(ctx context.Context, request operations.ListAllReportExecutionsRequest, opts ...operations.Option) (*operations.ListAllReportExecutionsResponse, error) {
...
func (s *Executions) Get(ctx context.Context, reportExecutionID string, merchantAccountID *string, opts ...operations.Option) (*components.ReportExecution, error) {
	request := operations.GetReportExecutionRequest{
		ReportExecutionID: reportExecutionID,
		MerchantAccountID: merchantAccountID,
	}

	globals := operations.GetReportExecutionGlobals{
		MerchantAccountID: s.sdkConfiguration.Globals.MerchantAccountID,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/report-executions/{report_execution_id}", request, globals)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ReportExecution
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
