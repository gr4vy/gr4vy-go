...
func newGiftCards(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *GiftCards {
	return &GiftCards{
		rootSDK:          rootSDK,
...
func (s *GiftCards) Delete(ctx context.Context, giftCardID string, merchantAccountID *string, opts ...operations.Option) error {
