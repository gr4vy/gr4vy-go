...
func newJobs(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Jobs {
	return &Jobs{
		rootSDK:          rootSDK,
...
func (s *Jobs) Create(ctx context.Context, accountUpdaterJobCreate components.AccountUpdaterJobCreate, merchantAccountID *string, opts ...operations.Option) (*components.AccountUpdaterJob, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/account-updater/jobs")
	if err != nil {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "AccountUpdaterJobCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AccountUpdaterJob
