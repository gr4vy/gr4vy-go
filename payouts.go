...
func newPayouts(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Payouts {
	return &Payouts{
		rootSDK:          rootSDK,
...
func (s *Payouts) List(ctx context.Context, cursor *string, limit *int64, merchantAccountID *string, opts ...operations.Option) (*operations.ListPayoutsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/payouts")
	if err != nil {
...
func (s *Payouts) Create(ctx context.Context, payoutCreate components.PayoutCreate, merchantAccountID *string, opts ...operations.Option) (*components.PayoutSummary, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PayoutCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PayoutSummary
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
