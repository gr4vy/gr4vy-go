...
func newActions(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Actions {
	return &Actions{
		rootSDK:          rootSDK,
...
func (s *Actions) List(ctx context.Context, transactionID string, merchantAccountID *string, opts ...operations.Option) (*components.TransactionActions, error) {
	...
	globals := operations.ListTransactionActionsGlobals{
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/transactions/{transaction_id}/actions", request, globals)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.TransactionActions
