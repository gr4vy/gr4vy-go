...
type TransactionHistoryEvents struct {
	...
	Items *[]TransactionHistoryEvent `json:"items,omitempty"`
...
func (o *TransactionHistoryEvents) GetItems() []TransactionHistoryEvent {
	if o == nil || o.Items == nil {
		var ret []TransactionHistoryEvent
		return ret
	}
	return *o.Items
}
...
// SetItems gets a reference to the given []TransactionHistoryEvent and assigns it to the Items field.
