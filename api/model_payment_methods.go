...
type PaymentMethods struct {
	...
	Items *[]OneOfCardRequestRedirectRequest `json:"items,omitempty"`
...
func (o *PaymentMethods) GetItems() []OneOfCardRequestRedirectRequest {
	if o == nil || o.Items == nil {
		var ret []OneOfCardRequestRedirectRequest
		return ret
	}
	return *o.Items
}
...
// SetItems gets a reference to the given []OneOfCardRequestRedirectRequest and assigns it to the Items field.
