...
func (v NullableRoleAssignments) Get() *RoleAssignments {
	return v.value
}

func (v *NullableRoleAssignments) Set(val *RoleAssignments) {
	v.value = val
	v.isSet = true
}
...
func NewNullableRoleAssignments(val *RoleAssignments) *NullableRoleAssignments {
	return &NullableRoleAssignments{value: val, isSet: true}
}
