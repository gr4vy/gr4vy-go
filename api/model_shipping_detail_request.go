...
type NullableShippingDetailRequest struct {
	value *ShippingDetailRequest
	isSet bool
}

func (v NullableShippingDetailRequest) Get() *ShippingDetailRequest {
	return v.value
}

func (v *NullableShippingDetailRequest) Set(val *ShippingDetailRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableShippingDetailRequest) IsSet() bool {
	return v.isSet
}
...
func NewNullableShippingDetailRequest(val *ShippingDetailRequest) *NullableShippingDetailRequest {
	return &NullableShippingDetailRequest{value: val, isSet: true}
}
