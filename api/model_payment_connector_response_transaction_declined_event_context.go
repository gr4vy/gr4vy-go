...
func NewPaymentConnectorResponseTransactionDeclinedEventContext() *PaymentConnectorResponseTransactionDeclinedEventContext {
	this := PaymentConnectorResponseTransactionDeclinedEventContext{}
	return &this
}
...
func (o *PaymentConnectorResponseTransactionDeclinedEventContext) SetCodeNil() {
	o.Code.Set(nil)
}
...
func (o *PaymentConnectorResponseTransactionDeclinedEventContext) SetRawResponseCodeNil() {
...
func (o *PaymentConnectorResponseTransactionDeclinedEventContext) SetAvsResponseCodeNil() {
...
func (o *PaymentConnectorResponseTransactionDeclinedEventContext) SetCvvResponseCodeNil() {
...
type NullablePaymentConnectorResponseTransactionDeclinedEventContext struct {
	value *PaymentConnectorResponseTransactionDeclinedEventContext
	isSet bool
}

func (v NullablePaymentConnectorResponseTransactionDeclinedEventContext) Get() *PaymentConnectorResponseTransactionDeclinedEventContext {
	return v.value
}

func (v *NullablePaymentConnectorResponseTransactionDeclinedEventContext) Set(val *PaymentConnectorResponseTransactionDeclinedEventContext) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentConnectorResponseTransactionDeclinedEventContext) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentConnectorResponseTransactionDeclinedEventContext) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentConnectorResponseTransactionDeclinedEventContext(val *PaymentConnectorResponseTransactionDeclinedEventContext) *NullablePaymentConnectorResponseTransactionDeclinedEventContext {
	return &NullablePaymentConnectorResponseTransactionDeclinedEventContext{value: val, isSet: true}
}

func (v NullablePaymentConnectorResponseTransactionDeclinedEventContext) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentConnectorResponseTransactionDeclinedEventContext) UnmarshalJSON(src []byte) error {
	v.isSet = true
