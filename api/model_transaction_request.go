...
type TransactionRequest struct {
	...
	PaymentMethod OneOfCardRequestRedirectRequestTokenizedRequest `json:"payment_method"`
	...
	ThreeDSecureData OneOfThreeDSecureDataV1ThreeDSecureDataV2 `json:"three_d_secure_data,omitempty"`
}
...
// If the value is explicit nil, the zero value for OneOfCardRequestRedirectRequestTokenizedRequest will be returned
func (o *TransactionRequest) GetPaymentMethod() OneOfCardRequestRedirectRequestTokenizedRequest {
	if o == nil {
		var ret OneOfCardRequestRedirectRequestTokenizedRequest
		return ret
	}
...
// GetThreeDSecureData returns the ThreeDSecureData field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *TransactionRequest) GetThreeDSecureData() OneOfThreeDSecureDataV1ThreeDSecureDataV2 {
	if o == nil  {
		var ret OneOfThreeDSecureDataV1ThreeDSecureDataV2
		return ret
	}
...
// SetThreeDSecureData gets a reference to the given OneOfThreeDSecureDataV1ThreeDSecureDataV2 and assigns it to the ThreeDSecureData field.
