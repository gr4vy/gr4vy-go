...
------------ | ------------- | ------------- | -------------
**Items** | Pointer to [**[]OneOfCardRequestRedirectRequest**](OneOfCardRequestRedirectRequest.md) | A list of stored payment methods. | [optional] 
...
`func (o *PaymentMethods) GetItems() []OneOfCardRequestRedirectRequest`

GetItems returns the Items field if non-nil, zero value otherwise.

### GetItemsOk

`func (o *PaymentMethods) GetItemsOk() (*[]OneOfCardRequestRedirectRequest, bool)`
...
`func (o *PaymentMethods) SetItems(v []OneOfCardRequestRedirectRequest)`
