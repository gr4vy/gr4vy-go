...
**BillingDetails** | Pointer to [**BillingDetails**](BillingDetails.md) | The billing details associated with the buyer, which include the address and tax ID. | [optional] 
