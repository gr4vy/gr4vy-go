...
**GiftCards** | Pointer to [**[]TransactionGiftCardRequest**](TransactionGiftCardRequest.md) | The optional gift-card to use for this transaction. At least one gift card is required if no other &#x60;payment_method&#x60; has been added. | [optional] 
