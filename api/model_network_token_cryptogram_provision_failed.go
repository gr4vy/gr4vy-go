...
func NewNetworkTokenCryptogramProvisionFailed() *NetworkTokenCryptogramProvisionFailed {
	this := NetworkTokenCryptogramProvisionFailed{}
	return &this
}
...
func (o *NetworkTokenCryptogramProvisionFailed) GetContext() NetworkTokenCryptogramProvisionFailedContext {
	if o == nil || o.Context == nil {
		var ret NetworkTokenCryptogramProvisionFailedContext
		return ret
	}
	return *o.Context
}
...
type NullableNetworkTokenCryptogramProvisionFailed struct {
	value *NetworkTokenCryptogramProvisionFailed
	isSet bool
}

func (v NullableNetworkTokenCryptogramProvisionFailed) Get() *NetworkTokenCryptogramProvisionFailed {
	return v.value
}

func (v *NullableNetworkTokenCryptogramProvisionFailed) Set(val *NetworkTokenCryptogramProvisionFailed) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkTokenCryptogramProvisionFailed) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkTokenCryptogramProvisionFailed) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkTokenCryptogramProvisionFailed(val *NetworkTokenCryptogramProvisionFailed) *NullableNetworkTokenCryptogramProvisionFailed {
	return &NullableNetworkTokenCryptogramProvisionFailed{value: val, isSet: true}
}

func (v NullableNetworkTokenCryptogramProvisionFailed) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkTokenCryptogramProvisionFailed) UnmarshalJSON(src []byte) error {
	v.isSet = true
