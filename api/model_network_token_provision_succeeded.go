...
func NewNetworkTokenProvisionSucceeded() *NetworkTokenProvisionSucceeded {
	this := NetworkTokenProvisionSucceeded{}
	return &this
}
...
type NullableNetworkTokenProvisionSucceeded struct {
	value *NetworkTokenProvisionSucceeded
	isSet bool
}

func (v NullableNetworkTokenProvisionSucceeded) Get() *NetworkTokenProvisionSucceeded {
	return v.value
}

func (v *NullableNetworkTokenProvisionSucceeded) Set(val *NetworkTokenProvisionSucceeded) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkTokenProvisionSucceeded) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkTokenProvisionSucceeded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkTokenProvisionSucceeded(val *NetworkTokenProvisionSucceeded) *NullableNetworkTokenProvisionSucceeded {
	return &NullableNetworkTokenProvisionSucceeded{value: val, isSet: true}
}
