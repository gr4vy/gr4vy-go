...
func (r ApiNewPaymentServiceRequest) Execute() (PaymentService, *_nethttp.Response, error) {
 ...
 */
func (a *PaymentServicesApiService) NewPaymentService(ctx _context.Context) ApiNewPaymentServiceRequest {
	return ApiNewPaymentServiceRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return PaymentService
 */
func (a *PaymentServicesApiService) NewPaymentServiceExecute(r ApiNewPaymentServiceRequest) (PaymentService, *_nethttp.Response, error) {
	var (
