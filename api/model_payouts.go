...
func (o *Payouts) SetNextCursorNil() {
...
func (o *Payouts) SetPreviousCursorNil() {
...
func (o Payouts) MarshalJSON() ([]byte, error) {
...
type NullablePayouts struct {
	value *Payouts
	isSet bool
}

func (v NullablePayouts) Get() *Payouts {
	return v.value
}

func (v *NullablePayouts) Set(val *Payouts) {
	v.value = val
	v.isSet = true
}

func (v NullablePayouts) IsSet() bool {
	return v.isSet
}

func (v *NullablePayouts) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePayouts(val *Payouts) *NullablePayouts {
	return &NullablePayouts{value: val, isSet: true}
}

func (v NullablePayouts) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePayouts) UnmarshalJSON(src []byte) error {
	v.isSet = true
