...
func NewGiftCardRedemptionSucceeded() *GiftCardRedemptionSucceeded {
	this := GiftCardRedemptionSucceeded{}
	return &this
}
...
type NullableGiftCardRedemptionSucceeded struct {
	value *GiftCardRedemptionSucceeded
	isSet bool
}

func (v NullableGiftCardRedemptionSucceeded) Get() *GiftCardRedemptionSucceeded {
	return v.value
}

func (v *NullableGiftCardRedemptionSucceeded) Set(val *GiftCardRedemptionSucceeded) {
	v.value = val
	v.isSet = true
}

func (v NullableGiftCardRedemptionSucceeded) IsSet() bool {
	return v.isSet
}

func (v *NullableGiftCardRedemptionSucceeded) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGiftCardRedemptionSucceeded(val *GiftCardRedemptionSucceeded) *NullableGiftCardRedemptionSucceeded {
	return &NullableGiftCardRedemptionSucceeded{value: val, isSet: true}
}
