...
func (r ApiAddRoleAssignmentRequest) RoleAssignmentRequest(roleAssignmentRequest RoleAssignmentRequest) ApiAddRoleAssignmentRequest {
	r.roleAssignmentRequest = &roleAssignmentRequest
	return r
}

func (r ApiAddRoleAssignmentRequest) Execute() (RoleAssignment, *_nethttp.Response, error) {
	return r.ApiService.AddRoleAssignmentExecute(r)
}

/*
 * AddRoleAssignment New role assignment
 ...
 */
func (a *RolesApiService) AddRoleAssignment(ctx _context.Context) ApiAddRoleAssignmentRequest {
	return ApiAddRoleAssignmentRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 */
func (a *RolesApiService) AddRoleAssignmentExecute(r ApiAddRoleAssignmentRequest) (RoleAssignment, *_nethttp.Response, error) {
	var (
