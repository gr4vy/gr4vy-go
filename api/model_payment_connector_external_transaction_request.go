...
func NewPaymentConnectorExternalTransactionRequest() *PaymentConnectorExternalTransactionRequest {
	this := PaymentConnectorExternalTransactionRequest{}
	return &this
}
...
func (o *PaymentConnectorExternalTransactionRequest) GetContext() PaymentConnectorExternalTransactionRequestContext {
	if o == nil || o.Context == nil {
		var ret PaymentConnectorExternalTransactionRequestContext
		return ret
	}
	return *o.Context
}
...
func (o PaymentConnectorExternalTransactionRequest) MarshalJSON() ([]byte, error) {
...
type NullablePaymentConnectorExternalTransactionRequest struct {
	value *PaymentConnectorExternalTransactionRequest
	isSet bool
}

func (v NullablePaymentConnectorExternalTransactionRequest) Get() *PaymentConnectorExternalTransactionRequest {
	return v.value
}

func (v *NullablePaymentConnectorExternalTransactionRequest) Set(val *PaymentConnectorExternalTransactionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentConnectorExternalTransactionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentConnectorExternalTransactionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentConnectorExternalTransactionRequest(val *PaymentConnectorExternalTransactionRequest) *NullablePaymentConnectorExternalTransactionRequest {
	return &NullablePaymentConnectorExternalTransactionRequest{value: val, isSet: true}
}

func (v NullablePaymentConnectorExternalTransactionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentConnectorExternalTransactionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
