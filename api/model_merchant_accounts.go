...
func (v NullableMerchantAccounts) Get() *MerchantAccounts {
	return v.value
}

func (v *NullableMerchantAccounts) Set(val *MerchantAccounts) {
	v.value = val
	v.isSet = true
}
...
func NewNullableMerchantAccounts(val *MerchantAccounts) *NullableMerchantAccounts {
	return &NullableMerchantAccounts{value: val, isSet: true}
}
