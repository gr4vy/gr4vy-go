...
func NewThreeDSecureAuthenticationRequestEvent() *ThreeDSecureAuthenticationRequestEvent {
	this := ThreeDSecureAuthenticationRequestEvent{}
	return &this
}
...
func (o *ThreeDSecureAuthenticationRequestEvent) GetContext() ThreeDSecureAuthenticationRequestEventContext {
	if o == nil || o.Context == nil {
		var ret ThreeDSecureAuthenticationRequestEventContext
		return ret
	}
	return *o.Context
}
...
type NullableThreeDSecureAuthenticationRequestEvent struct {
	value *ThreeDSecureAuthenticationRequestEvent
	isSet bool
}

func (v NullableThreeDSecureAuthenticationRequestEvent) Get() *ThreeDSecureAuthenticationRequestEvent {
	return v.value
}

func (v *NullableThreeDSecureAuthenticationRequestEvent) Set(val *ThreeDSecureAuthenticationRequestEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableThreeDSecureAuthenticationRequestEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableThreeDSecureAuthenticationRequestEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThreeDSecureAuthenticationRequestEvent(val *ThreeDSecureAuthenticationRequestEvent) *NullableThreeDSecureAuthenticationRequestEvent {
	return &NullableThreeDSecureAuthenticationRequestEvent{value: val, isSet: true}
}

func (v NullableThreeDSecureAuthenticationRequestEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThreeDSecureAuthenticationRequestEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
