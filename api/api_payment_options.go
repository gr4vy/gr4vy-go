...
func (r ApiPostListPaymentOptionsRequest) Execute() (PaymentOptions, *_nethttp.Response, error) {
 ...
 */
func (a *PaymentOptionsApiService) PostListPaymentOptions(ctx _context.Context) ApiPostListPaymentOptionsRequest {
	return ApiPostListPaymentOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
 ...
 * @return PaymentOptions
 */
func (a *PaymentOptionsApiService) PostListPaymentOptionsExecute(r ApiPostListPaymentOptionsRequest) (PaymentOptions, *_nethttp.Response, error) {
	var (
