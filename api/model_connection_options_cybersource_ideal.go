...
// ConnectionOptionsCybersourceIdeal Additional options for Cybersource iDeal APM.
type ConnectionOptionsCybersourceIdeal struct {
...
func NewConnectionOptionsCybersourceIdeal() *ConnectionOptionsCybersourceIdeal {
	this := ConnectionOptionsCybersourceIdeal{}
	return &this
}
...
func (o *ConnectionOptionsCybersourceIdeal) SetMetaKeyMerchantIdNil() {
...
func (o *ConnectionOptionsCybersourceIdeal) SetShipToMethodNil() {
...
func (o ConnectionOptionsCybersourceIdeal) MarshalJSON() ([]byte, error) {
...
type NullableConnectionOptionsCybersourceIdeal struct {
	value *ConnectionOptionsCybersourceIdeal
	isSet bool
}

func (v NullableConnectionOptionsCybersourceIdeal) Get() *ConnectionOptionsCybersourceIdeal {
	return v.value
}

func (v *NullableConnectionOptionsCybersourceIdeal) Set(val *ConnectionOptionsCybersourceIdeal) {
	v.value = val
	v.isSet = true
}

func (v NullableConnectionOptionsCybersourceIdeal) IsSet() bool {
	return v.isSet
}

func (v *NullableConnectionOptionsCybersourceIdeal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConnectionOptionsCybersourceIdeal(val *ConnectionOptionsCybersourceIdeal) *NullableConnectionOptionsCybersourceIdeal {
	return &NullableConnectionOptionsCybersourceIdeal{value: val, isSet: true}
}

func (v NullableConnectionOptionsCybersourceIdeal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConnectionOptionsCybersourceIdeal) UnmarshalJSON(src []byte) error {
	v.isSet = true
