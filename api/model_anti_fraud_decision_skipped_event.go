...
func NewAntiFraudDecisionSkippedEvent() *AntiFraudDecisionSkippedEvent {
	this := AntiFraudDecisionSkippedEvent{}
	return &this
}
...
func (o *AntiFraudDecisionSkippedEvent) GetContext() AntiFraudDecisionSkippedEventContext {
	if o == nil || o.Context == nil {
		var ret AntiFraudDecisionSkippedEventContext
		return ret
	}
	return *o.Context
}
...
type NullableAntiFraudDecisionSkippedEvent struct {
	value *AntiFraudDecisionSkippedEvent
	isSet bool
}

func (v NullableAntiFraudDecisionSkippedEvent) Get() *AntiFraudDecisionSkippedEvent {
	return v.value
}

func (v *NullableAntiFraudDecisionSkippedEvent) Set(val *AntiFraudDecisionSkippedEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableAntiFraudDecisionSkippedEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableAntiFraudDecisionSkippedEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAntiFraudDecisionSkippedEvent(val *AntiFraudDecisionSkippedEvent) *NullableAntiFraudDecisionSkippedEvent {
	return &NullableAntiFraudDecisionSkippedEvent{value: val, isSet: true}
}
