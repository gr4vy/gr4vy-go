...
type NullableError404PendingCreation struct {
	value *Error404PendingCreation
	isSet bool
}

func (v NullableError404PendingCreation) Get() *Error404PendingCreation {
	return v.value
}

func (v *NullableError404PendingCreation) Set(val *Error404PendingCreation) {
	v.value = val
	v.isSet = true
}

func (v NullableError404PendingCreation) IsSet() bool {
	return v.isSet
}

func (v *NullableError404PendingCreation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableError404PendingCreation(val *Error404PendingCreation) *NullableError404PendingCreation {
	return &NullableError404PendingCreation{value: val, isSet: true}
}
