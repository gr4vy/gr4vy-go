...
func (v NullableReportExecutions) Get() *ReportExecutions {
	return v.value
}

func (v *NullableReportExecutions) Set(val *ReportExecutions) {
	v.value = val
	v.isSet = true
}
...
func NewNullableReportExecutions(val *ReportExecutions) *NullableReportExecutions {
	return &NullableReportExecutions{value: val, isSet: true}
}
