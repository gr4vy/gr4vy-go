...
func NewPaymentConnectorResponseTransactionAuthorizationFailedEvent() *PaymentConnectorResponseTransactionAuthorizationFailedEvent {
	this := PaymentConnectorResponseTransactionAuthorizationFailedEvent{}
	return &this
}
...
func (o *PaymentConnectorResponseTransactionAuthorizationFailedEvent) GetContext() PaymentConnectorResponseTransactionAuthorizationFailedEventContext {
	if o == nil || o.Context == nil {
		var ret PaymentConnectorResponseTransactionAuthorizationFailedEventContext
		return ret
	}
	return *o.Context
}
...
func (o PaymentConnectorResponseTransactionAuthorizationFailedEvent) MarshalJSON() ([]byte, error) {
...
type NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent struct {
	value *PaymentConnectorResponseTransactionAuthorizationFailedEvent
	isSet bool
}

func (v NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent) Get() *PaymentConnectorResponseTransactionAuthorizationFailedEvent {
	return v.value
}

func (v *NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent) Set(val *PaymentConnectorResponseTransactionAuthorizationFailedEvent) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentConnectorResponseTransactionAuthorizationFailedEvent(val *PaymentConnectorResponseTransactionAuthorizationFailedEvent) *NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent {
	return &NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent{value: val, isSet: true}
}

func (v NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentConnectorResponseTransactionAuthorizationFailedEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
