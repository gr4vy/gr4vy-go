...
// WebhookSubscriptions struct for WebhookSubscriptions
type WebhookSubscriptions struct {
	// A list of webhook subscriptions.
	Items *[]WebhookSubscription `json:"items,omitempty"`
...
// SetItems gets a reference to the given []WebhookSubscription and assigns it to the Items field.
...
func (o *WebhookSubscriptions) SetNextCursorNil() {
...
func (o *WebhookSubscriptions) SetPreviousCursorNil() {
...
func (o WebhookSubscriptions) MarshalJSON() ([]byte, error) {
...
type NullableWebhookSubscriptions struct {
	value *WebhookSubscriptions
	isSet bool
}

func (v NullableWebhookSubscriptions) Get() *WebhookSubscriptions {
	return v.value
}

func (v *NullableWebhookSubscriptions) Set(val *WebhookSubscriptions) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookSubscriptions) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookSubscriptions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookSubscriptions(val *WebhookSubscriptions) *NullableWebhookSubscriptions {
	return &NullableWebhookSubscriptions{value: val, isSet: true}
}

func (v NullableWebhookSubscriptions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookSubscriptions) UnmarshalJSON(src []byte) error {
	v.isSet = true
