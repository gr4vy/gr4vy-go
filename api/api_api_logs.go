...
func (r ApiListApiLogsRequest) Execute() (ApiLogs, *_nethttp.Response, error) {
	return r.ApiService.ListApiLogsExecute(r)
}
 ...
 */
func (a *APILogsApiService) ListApiLogs(ctx _context.Context) ApiListApiLogsRequest {
	return ApiListApiLogsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *APILogsApiService) ListApiLogsExecute(r ApiListApiLogsRequest) (ApiLogs, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  ApiLogs
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APILogsApiService.ListApiLogs")
	if err != nil {
