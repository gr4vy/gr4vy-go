...
// PaymentLinks A list of payment links.
...
// SetItems gets a reference to the given []PaymentLink and assigns it to the Items field.
...
func (o *PaymentLinks) SetNextCursorNil() {
...
func (o *PaymentLinks) SetPreviousCursorNil() {
...
func (o PaymentLinks) MarshalJSON() ([]byte, error) {
...
type NullablePaymentLinks struct {
	value *PaymentLinks
	isSet bool
}

func (v NullablePaymentLinks) Get() *PaymentLinks {
	return v.value
}

func (v *NullablePaymentLinks) Set(val *PaymentLinks) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentLinks) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentLinks) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentLinks(val *PaymentLinks) *NullablePaymentLinks {
	return &NullablePaymentLinks{value: val, isSet: true}
}

func (v NullablePaymentLinks) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentLinks) UnmarshalJSON(src []byte) error {
	v.isSet = true
