...
type Buyers struct {
	PaymentMethods  *BuyersPaymentMethods
	GiftCards       *BuyersGiftCards
...
func newBuyers(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Buyers {
	return &Buyers{
		rootSDK:          rootSDK,
		sdkConfiguration: sdkConfig,
		hooks:            hooks,
		PaymentMethods:   newBuyersPaymentMethods(rootSDK, sdkConfig, hooks),
		GiftCards:        newBuyersGiftCards(rootSDK, sdkConfig, hooks),
		ShippingDetails:  newShippingDetails(rootSDK, sdkConfig, hooks),
	}
}
...
func (s *Buyers) List(ctx context.Context, request operations.ListBuyersRequest, opts ...operations.Option) (*operations.ListBuyersResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/buyers")
	if err != nil {
	...
	res := &operations.ListBuyersResponse{}
	res.Next = func() (*operations.ListBuyersResponse, error) {
...
func (s *Buyers) Create(ctx context.Context, buyerCreate components.BuyerCreate, merchantAccountID *string, opts ...operations.Option) (*components.Buyer, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "BuyerCreate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *Buyers) Get(ctx context.Context, buyerID string, merchantAccountID *string, opts ...operations.Option) (*components.Buyer, error) {
...
func (s *Buyers) Update(ctx context.Context, buyerID string, buyerUpdate components.BuyerUpdate, merchantAccountID *string, opts ...operations.Option) (*components.Buyer, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "BuyerUpdate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
