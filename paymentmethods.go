...
func newPaymentMethods(rootSDK *Gr4vy, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PaymentMethods {
	return &PaymentMethods{
		rootSDK:              rootSDK,
		sdkConfiguration:     sdkConfig,
		hooks:                hooks,
		PaymentServiceTokens: newPaymentServiceTokens(rootSDK, sdkConfig, hooks),
		NetworkTokens:        newNetworkTokens(rootSDK, sdkConfig, hooks),
	}
}
...
func (s *PaymentMethods) List(ctx context.Context, request operations.ListPaymentMethodsRequest, opts ...operations.Option) (*operations.ListPaymentMethodsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/payment-methods")
	if err != nil {
	...
	res.Next = func() (*operations.ListPaymentMethodsResponse, error) {
...
func (s *PaymentMethods) Get(ctx context.Context, paymentMethodID string, merchantAccountID *string, opts ...operations.Option) (*components.PaymentMethod, error) {
...
func (s *PaymentMethods) Update(ctx context.Context, paymentMethodID string, paymentMethodUpdate components.PaymentMethodUpdate, merchantAccountID *string, opts ...operations.Option) (*components.PaymentMethod, error) {
	request := operations.UpdatePaymentMethodRequest{
		PaymentMethodID:     paymentMethodID,
		MerchantAccountID:   merchantAccountID,
		PaymentMethodUpdate: paymentMethodUpdate,
	}

	globals := operations.UpdatePaymentMethodGlobals{
		MerchantAccountID: s.sdkConfiguration.Globals.MerchantAccountID,
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PaymentMethodUpdate", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
...
func (s *PaymentMethods) Delete(ctx context.Context, paymentMethodID string, merchantAccountID *string, opts ...operations.Option) error {
